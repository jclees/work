...
Page({
  ...
  switchTab: function(e) {
    ...
    debugger
    //绘本分享
    that.getBookShare(that.data.currentTab)
  },
  // 点击标题切换当前页时改变样式
  swichNav: function(e) {
    let that = this
  ...
  //   app.turnToPage('/pages/orderDetails/orderDetails?book_id=' + id)
  // },
  getData() { //初始化数据
    let that = this
    //绘本分享
  ...
  getBookShare(type) { //绘本分享
    let that = this
    // debugger
    common.get('/index/myBooks', {
