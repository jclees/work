    ...
    wx.onSocketMessage((res) => {
      ...
      switch (data.action) {
        ...
        case 'fpk_wg_succ'://重置切换好友对战用户
          ...
          console.log(data.from_client_info.openid)
          console.log(data.to_client_info.openid)
...
const socket = new Socket('wss://caibei.weixingzpt.com/ws');//socket连接 http:ws|https:wss
