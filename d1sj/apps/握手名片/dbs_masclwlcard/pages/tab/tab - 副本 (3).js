...
Page({
  ...
  onLoad: function(t) {
    ...
    if (wx.getSystemInfo({
      ...
      (n = wx.getStorageSync("member_id")) && t.parent_id
    )
      n == t.parent_id ? (e = 0,
      ...
      if (!n && !t.parent_id) return e = 0,//没有member_id 也没有分享人进入 (搜索名片进入)
...
debugger
      if (!n && t.parent_id) return e = 1,//没有member_id 分享人进入
        o = t.parent_id,
        app.savaRecord({
          type: 4,
          member_id: n,
  ...
  change_footer_name: function(t) {
    ...
    if (wx.getUserInfo({
      ...
      }), 0 == d) 1 == e && app.savaRecord({
      type: 4,
      member_id: n,
      be_member_id: o
    });
    else if (1 == d) 1 == e && app.savaRecord({
      type: 16,
      member_id: n,
      be_member_id: o
    });
    else if (2 == d) 1 == e && app.savaRecord({
      type: 2,
      member_id: n,
      be_member_id: o
    });
